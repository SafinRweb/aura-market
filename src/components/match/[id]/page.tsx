...
export default function MatchPage() {
  ...
  function handleSelectOutcome(marketType: MarketType, outcome: string, outcomeLabel: string) {
    ...
    <AppLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="card p-6 mb-6 animate-slide-up">
            ...
            <div className="flex flex-col items-center px-6">
              {match.status === "live" || match.status === "finished" ? (
                ...
                <div className="text-center">
                  ...
                  <CountdownTimer kickoffTime={match.kickoff_time} status={match.status} />
                </div>
              )}
            </div>
          ...
          {/* Match info */}
          <div className="flex items-center justify-center gap-6 border-t-2 border-border pt-4">
              ...
              <div className="bg-pink-dim border-2 border-pink-DEFAULT p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-faint text-xs mt-1">
                    {match.status === "live" ? "MATCH IS IN PROGRESS" : "THIS MATCH HAS ENDED"}
                  </p>
                </div>
              </div>
            )}
